...
/**
 * 气泡样式的FrameLayout布局 支持自定义气泡样式
 *
 * Created by caijw on 2016/5/26. https://github.com/cpiz/BubbleView
 */
@SuppressWarnings("unused")
public class BubbleFrameLayout extends FrameLayout implements BubbleStyle,
		BubbleCallback {
