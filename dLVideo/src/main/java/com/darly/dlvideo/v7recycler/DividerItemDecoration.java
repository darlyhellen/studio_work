...
/**
 * @author zhangyh2 a 上午11:10:47 TODO
 */
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
	...
	private void drawVertical(Canvas canvas, RecyclerView parent) {
		final float left = parent.getPaddingLeft() + 10;
		final float right = parent.getMeasuredWidth() - parent.getPaddingRight()
				- 10;
		...
		for (int i = 0; i < childSize; i++) {
			...
			final float bottom = top + 0.6f/* mItemSize */;
			canvas.drawRect(left, top, right / 3 - 10, bottom, mPaint);
			canvas.drawRect(right / 2 - 10, top, right / 2 + 10, bottom, mPaint);
			canvas.drawRect(right * 2 / 3 + 10, top, right, bottom, mPaint);
		}
	}
