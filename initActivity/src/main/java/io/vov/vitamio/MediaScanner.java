  ...
  private class MyMediaScannerClient implements MediaScannerClient {
    ...
    private ContentValues toValues() {
      ...
      if (MediaFile.isVideoFileType(mFileType)) {
        map.put(VideoColumns.DURATION, mDuration);
        map.put(VideoColumns.LANGUAGE, mLanguage);
        map.put(VideoColumns.ALBUM, mAlbum);
        map.put(VideoColumns.ARTIST, mArtist);
        map.put(VideoColumns.WIDTH, mWidth);
        map.put(VideoColumns.HEIGHT, mHeight);
      }
