  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
	...
	public void setVideoLayout(int layout, float aspectRatio) {
		...
		if (VIDEO_LAYOUT_ORIGIN == layout && mSurfaceWidth < windowWidth && mSurfaceHeight < windowHeight) {
			...
			lp.width = (parentRatio < videoRatio) ? parent.getWidth() : Math.round((parent.getHeight()) * videoRatio);
			lp.height = (parentRatio > videoRatio) ? parent.getHeight() : Math.round((parent.getWidth()) / videoRatio);
		} else {
